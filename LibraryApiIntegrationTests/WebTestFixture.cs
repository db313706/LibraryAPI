    ...
    public class WebTestFixture : WebApplicationFactory<Startup>
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                db.Books.AddRange(
                        new Book { Title="Jaws", Author="Benchely", NumberOfPages=289, InStock=true },
                        new Book { Title = "Fight Club", Author = "Poluiuck", NumberOfPages = 289, InStock = true },
                        new Book { Title = "Jaws", Author = "Benchely", NumberOfPages = 289, InStock = false }
                    );
                db.SaveChanges();
            });
        }
